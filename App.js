...
import { CartProvider } from './contexts/CartContext'; // ✅ Importação do CartProvider
...
export default function App() {
  return (
    <AuthProvider>
      <UserProvider>
        <CartProvider> {/* ✅ Envolvendo a navegação com o CartProvider */}
          <NavigationContainer>
            <Stack.Navigator initialRouteName="Login">
              ...
              <Stack.Screen
                ...
                options={{ headerShown: false }}
              />
              <Stack.Screen name="Pagamento" component={PaymentScreen} options={{ headerShown: false }} />
